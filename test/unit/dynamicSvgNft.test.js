...
!developmentChains.includes(network.name)
   ...
   : describe("DynamicSvgNFT", () => {
        let dynamicSvgNft, mockV3Aggregator, signer
        ...
        beforeEach(async () => {
           ...
           const mockDeployments = await deployments.get("MockV3Aggregator")
        ...
        describe("mintNft", () => {
           ...
           it("token uri lower when the price doesn't surpass the highvalue", async () => {
              const highValue = ethers.parseEther("2000000")
           ...
           it("shifts the token uri to higher when the price surpass the highvalue", async function () {
              const highValue = 20n // $100,000,000 dollar per ether. Maybe in the distant future this test will fail...
